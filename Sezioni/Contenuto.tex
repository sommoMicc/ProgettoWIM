...
Nei risultati di ricerca e nelle pagine prodotto viene visualizzata una breadcrumb inutile, perché indica sempre come punto di partenza "Pagina principale", e non riporta il percorso completo che l'utente effettivamente ha svolto.